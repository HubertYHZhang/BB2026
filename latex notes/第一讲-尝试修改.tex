...
\begin{itemize}
  ...
  \item 把本讲提出的一连串问题，当作后续各讲（尺子、产权、外部性、信息、家庭、平台、制度）的引子。
\end{itemize}
\end{goalsbox}
...
和后面几讲不同，本讲\textbf{不急于交付一件具体的分析工具}。它的任务只有两个：一是用市场这一无处不在的制度作为例子，把一种制度的存在「去自然化」；二是为之后的内容埋下问题。你会发现，解释「市场的边界」会同时牵动好几种不同的解释方式——效率的、历史的、规范的，这些解释方式是今后需要常讨论的；而效率取向当中涉及到的经济学概念则是本课程后续侧重分析的内容。
\end{keybox}
...
\textcolor{red}{这里还问这个问题就太低级了，必须把「效率取向」的解释提一下。}
\end{insightbox}
...
如何讨论一件事情/一项制度的利弊？我们需要明确我们在乎的是什么。\textcolor{red}{To be continued.}
\end{discussionbox}
...
当一个互动有好几个稳定结果（比如大家都靠左走、和大家都靠右走，其实都行得通；这一点在讲制度的那一讲会展开），经济学会告诉你「最后会落到某一个」，但落到哪一个它答不了。那个空位，只能由历史、权力、习惯和偶然来填。这就是历史视角进入经济学最合法的位置：不是到处都需要历史，而是在「均衡不唯一」的那道缝里，历史是必需的。
\end{conceptbox}
...
\begin{insightbox}{本讲唯一要你现在就戴上的「眼镜」}
后面每一讲都会交给你一件具体工具，但本讲只给你一副眼镜：看任何一个社会现象，都先把它拆开成「一群各有目的的人，在各自的约束和信息下做出选择，这些选择再汇成一个没有谁单独设计的结果」。戴上它，黄牛就不再只是「坏人」，而是「在排队规则的缝隙里对激励作出反应的人」；先学会这样看，后面的工具才有地方安放。而这些选择「如何汇成一个结果」本身就大有讲究——有时汇成奇妙的秩序，有时汇成糟糕的僵局——这正是后面几讲要反复回到的地方。
\end{insightbox}

\section{今天我们只提问：一张「欠条清单」}

这一讲几乎没有给出任何答案。这不是疏漏——它恰恰是第一讲的职责。我们今天做的，是把一堆平时被当成理所当然的东西摇松，让它们变回一个个真正的问题，然后\textbf{当众把这些问题记成「欠条」}，留给后面的课一张一张去偿还。下面就是今天欠下的账——把它倒过来看，其实就是这门课的目录：

\begin{itemize}
  \item \textbf{口罩涨价、学区房、演唱会黄牛，到底好不好？}——要回答，得先有一把衡量「好坏」的尺子。可快乐、公平、风险能不能加在一起？\emph{这笔账，留给下一讲「快乐的度量学」。}
  \item \textbf{排放权、域名这些「权利」是从哪冒出来的？求根公式为什么不收费？}——市场要先有人把「什么归谁」定下来，才转得起来。\emph{这笔账，留给讲「产权」的那一讲。}
  \item \textbf{外卖更方便了，可时间压力被转嫁给了骑手——这笔成本谁来付？}\emph{这笔账，留给讲「外部性」的那一讲。}
  \item \textbf{二手车、医疗里，买家根本看不出好坏，市场还转得动吗？}\emph{这笔账，留给讲「信息不对称」的那一讲。}
  \item \textbf{家里哪些事交给市场、哪些自己做？}（还记得开头那个做饭、打扫的例子吗）\emph{这笔账，留给讲「家庭」这种非市场制度的那一讲。}
  \item \textbf{外卖平台、算法、评分、抽成——这些规则是谁写的，又对谁有利？}\emph{这笔账，留给讲「平台」的那一讲。}
  \item \textbf{说到底，「市场的边界」是谁画的、为什么常常改不动？}\emph{这笔账，留给最后一讲「制度是从哪里来的」。}
\end{itemize}

\begin{insightbox}{带着问题走出教室}
如果今天你带着满肚子没被解答的问题离开——那恰恰说明这一讲成功了。后面每一讲，都是来还其中一张欠条的。
\end{insightbox}
