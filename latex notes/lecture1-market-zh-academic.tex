\documentclass[UTF8,10pt,a4paper,scheme=chinese,fontset=none]{ctexart}
...
\definecolor{signalbg}{HTML}{F8F4EC}
\definecolor{signalbar}{HTML}{D97757}
\definecolor{signaltext}{HTML}{3A342E}

\tikzset{
  callouthighlight/.style={
    inner xsep=2pt,
    inner ysep=1pt,
    draw=signalbar,
    line width=0.4pt,
...
\newcommand{\callout}[3]{%
  \tikz[remember picture,baseline=(#1.base)]{%
    \node[callouthighlight] (#1) {#2};%
  }%
  \todo[
    color=signalbg,
    linecolor=signalbar,
    bordercolor=signalbar,
    textcolor=signaltext,
    size=\footnotesize
  ]{#3}%
}
...
或许你在政治课本里、电视新闻上对「市场」有所了解。你或许会认为它是一个很宏大和抽象的词，不知道从何处开始分析它。又或许你觉得自己已经相当了解它，喧闹的菜市场、街边的房产中介、屏幕上红红绿绿的股票软件、每到旺季就节节攀升的酒店价格，无不散发着「市场」的铜臭味。如果你感到困惑了或无聊了，\callout{domainright}{不妨一起来看看这些有趣的例子}{
  这些案例说明了。
}，你可能会感到新奇。
...
从上述的讨论中，我们知道市场是一种广泛存在的制度，但从各种案例的对比中，我们发现它的范围也并非是不言自明的——即便是同类事物，有的会成为市场中的商品，有的则不会。这不禁让我们追问，
\begin{itemize}
  \item 我们如何思考市场的广泛存在和它的有限范围所带来的效果？
  \item 市场的存在和「边界」，乃至一项制度的存在和边界，是如何被决定的？
\end{itemize}

在回答这些问题之前，让我们先看一看几位知名的思想家对于市场的思考。
...
\textbf{我们这门课的一个重点，就是利用经济学的思维框架去思考一个制度的后果。}
...
我们往往认为市场是「配置稀缺资源的一种方式」。但稀缺资源可以通过多种方式配置：
\begin{itemize}
...
这些制度各有什么优缺点？它们存在的问题是否能被市场所解决？

\begin{center}
\small
\begin{tabular}{p{0.20\linewidth}p{0.16\linewidth}p{0.54\linewidth}}
\hline
\textbf{分配机制} & \textbf{关键词} & \textbf{核心问题} \tabularnewline
\hline
排队 & 时间 & 等待时间不一定代表真实需要或重视程度；时间充裕者反而更有优势。 \tabularnewline
抽签 & 随机 & 随机性保证机会平等，却不能保证资源落到最需要或最重视它的人手中。 \tabularnewline
行政审核 & 信息 & 审核者必须判断谁更需要、谁更符合资格，但真实情况往往难以观察，材料也可能被包装。 \tabularnewline
考试与竞赛 & 指标 & 一旦某个指标决定资源分配，行动者就会围绕指标训练、包装和竞争，指标本身可能被扭曲。 \tabularnewline
权力与关系 & 身份 & 资源分配依赖地位、关系和亲疏，标准不透明，也容易排斥外人。 \tabularnewline
赠与与义务 & 人情 & 看似温和的互助关系可能隐藏不对等义务、亏欠感和等级关系。交易的范围也受熟人圈子的限制。 \tabularnewline
\hline
\end{tabular}
\end{center}
...
% \end{insightbox}
\subsection{市场为何有效？}
单是拥有经济学的思维框架并不足以回答斯密的疑问。我们需要在市场的制度背景下追问：个体的行动如何被组织起来，为什么这些行动能够形成相对有效的秩序。

市场将这些机制结合在一起：
\begin{itemize}
  \item \textbf{交换带来互利。} 只要双方对同一物品的评价不同，交易就可能使双方都获得更偏好的东西。个体对于物品的渴望程度由支付意愿体现，价高者得的规则往往能使资源流向最需要的人。
  \item \textbf{价格传递相对稀缺性。} 个体不必知道短缺的全部原因；价格变化本身就足以改变节约、替代、生产或进入的行为。拥有私人信息的行动者也在利用信息赚取利润的同时将信息反映到了市场价格当中。
  \item \textbf{利润和亏损提供回应激励。} 卖方有理由生产、运输、搜索、改进和节约，许多有利可图的机会都使得参与者在谋利的同时也缓解了稀缺性；亏损则迫使无效安排被调整或退出。
  \item \textbf{竞争约束行为并发现信息。} 当买方能够转向其他卖方时，卖方必须关注价格和质量；同时，竞争也是一种试错过程，帮助人们发现哪些产品、技术和组织方式更可行。
  \item \textbf{大规模的市场参与者使专业化分工成为可能。} 随着市场活动范围的扩大，人们不必自给自足，而可以专门从事某些活动，再通过交换获得其余物品。
\end{itemize}

总的来说，市场主要解决了在大规模人群中的激励和信息问题，从而促进商品的生产和流通，且这种生产和流通回应了社会层面的稀缺性。

因此，市场的力量不在于参与者具有公共精神，而在于一套制度安排能够把私人动机、局部知识和分散决策转化为相对有序的供给体系。

\subsection{何为有效？}
斯密说市场好，我们说了市场这么多好处，那它究竟好不好呢？究竟如何衡量效率？经济学将效率的落脚点放在个体的福利（welfare）上。简单来讲，相比先前，个体能够得到自己更偏好的东西，这便意味着个体的福利得到了增进。但如何衡量总体的效率？如果我们将每个人的福利用一个数字衡量并简单地相加，就会出现许多反直觉的结论，比如一个人声称他获得一块钱的快乐能抵消其他人失去一块钱的痛苦的两倍不止，那么最优的分配应该是把社会上所有的财富都给这个人。因此，我们需要一个效率标准，它不做跨个体的福利比较。
...
由于市场是一个非常复杂的系统，经济学家借助数学工具推导个体在其中的行为和均衡状态下的社会总体状况。在一定的假设下，市场经济达成的均衡是帕累托最优的。
% \begin{conceptbox}{福利经济学第一定理}
  
% \end{conceptbox}

% 这绝对不意味着市场是完美的，是世界上最好的制度。这其中
...
经济学最擅长的是前两类问题。但功能不是起源。说市场处理了资源配置问题，并不意味着市场因此自然出现；说某制度降低交易成本，也不意味着它一定有效率或正当。不得不承认的是，经济学往往用功能主义的视角解释制度的存在，即一个制度的存在是因为它可以解决存在的某种问题。这包含着倒果为因的谬论和目的论的色彩，但这一视角也帮助我们理解了现实世界中可能存在的问题，引导我们思考这一制度是否解决、如何解决问题，如果没有这种制度会发生什么，以及我们如何设想更好的制度。我们还能以经济学的视角评估一个制度执行的结果，这对于政策制定者的视角来说非常重要。在这门课当中，我们将主要思考制度的功能问题，研究现实世界中普遍存在的几类问题，以及我们或许习以为常的制度是如何解决这些问题的。更重要的是，将制度问题化，使其成为我们思考的对象。
...
市场的功能并不能解决一切问题，甚至会产生新问题。

\begin{itemize}
  \item \textbf{支付能力不等于需求。} 学区房、口罩和演唱会门票可能流向支付能力最高者，而不是需求最强者。这样的分配可曰正义否？
  \item \textbf{部分成本由局外人承担。} 污染、交通拥堵、噪音等可能影响交易之外的人，而此种后果并不反映在交易的价格当中。
  \item \textbf{质量可能难以观察。} 医疗服务、二手车、补习和金融产品都很难由买方准确判断质量，信任问题可能导致交易无法达成。
  % \item \textbf{契约可能是不完全的。} 长期合作、雇佣、婚姻和平台劳动无法事先规定所有未来行动和状态。
  \item \textbf{定价可能改变意义。} 友谊、公共荣誉、选票和学业排名并不只是稀缺对象，它们嵌入了社会意义。如果把它们也纳入市场交易的范围，我们的道德观念将会遭到侵蚀。
\end{itemize}

% \begin{discussionbox}{评价}
% 任选一个案例：短缺时期的口罩、学区房、门票转售、医疗服务、外卖平台或付费代排队。市场解决了什么问题？又制造了什么问题？记得使用经济学的思维去分析哦。至于如何评价结果，由你自己决定。
% \end{discussionbox}

市场失灵并不只是说明市场「不好」，而是提示我们需要追问：现实社会用什么制度来弥补这些条件的缺失？这些将是接下来的课程所覆盖的内容。
...
\section{附录}
关于市场产生的历史过程，这些思想家提供了经济学以外的重要视角，他们揭示了市场制度背后更深层的历史背景
\begin{itemize}
